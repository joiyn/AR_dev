"""
═══════════════════════════════════════════════════════════════════════════════
SOLVER DE MIX D'APPARTEMENTS SUR GRILLE
═══════════════════════════════════════════════════════════════════════════════

Ce script trouve la configuration optimale (dimensions de grille + nombre 
d'appartements) pour respecter des pourcentages de surface imposés par un 
programme de concours architectural.

PRINCIPE DE FONCTIONNEMENT :
    1. Vous définissez les surfaces cibles pour chaque type d'appartement
    2. Vous définissez les pourcentages de répartition souhaités
    3. Le script teste différentes combinaisons de dimensions de grille et 
       de nombre d'éléments pour trouver celles qui respectent vos contraintes
    4. Les résultats sont sauvegardés dans un fichier texte détaillé

USAGE : 
    1. Modifiez les paramètres dans la section "PARAMÈTRES D'ENTRÉE" ci-dessous
    2. Lancez dans le terminal : python run.py
    3. Consultez le fichier généré dans le dossier "results/"
    
"""

from explorer import explore_solutions
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# SEARCH_RANGE : Largeur des cellules de grille (en mètres)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#
# 🎯 FONCTIONNEMENT :
...
search_step = 0.1  # Teste toutes les 10cm (précis, temps raisonnable)
...
target_elements_range = (15, 60)  # Teste de 10 à 35 unités de grille
                                  # Le script testera CHAQUE valeur : 10, 11, 12, ..., 34, 35


# ═══════════════════════════════════════════════════════════════════════════
# PARAMÈTRES D'ENTRÉE - À CONFIGURER SELON VOS BESOINS
# ═══════════════════════════════════════════════════════════════════════════
...
apt_areas = {
    #"1p": 30,   # Un appartement 1 pièce doit faire environ 20 m²
    "2.5p": 60,   # Un appartement 2.5 pièces doit faire environ 60 m²
    "3.5p": 80,   # Un appartement 3.5 pièces doit faire environ 80 m²
    "4.5p": 95,   # Un appartement 4.5 pièces doit faire environ 95 m²
    "5.5p": 110   # Un appartement 5.5 pièces doit faire environ 110 m²
}
...
net_to_floor_factor = 1.12  # Ajustez selon votre standard/projet
...
percentage_tolerance = 2.0  # Tolérance de ±7% autour de chaque pourcentage cible
...
quantum = 0.5  # Arrondit à 0.5 près (bon compromis précision/vitesse)
...
method = "round"  # Arrondit au quantum le plus proche
...
nombre_logements = 150  # Nombre total d'appartements du projet
...
max_etages_par_batiment = 4.5  # Maximum d'étages par bâtiment

# ┌─────────────────────────────────────────────────────────────────────────┐
# │ AFFICHAGE ET SAUVEGARDE DES RÉSULTATS                                │
# └─────────────────────────────────────────────────────────────────────────┘s

max_solutions_displayed = 100  # Top 100 solutions dans le fichier
...
save_to_file = True  # Sauvegarde dans un fichier .txt avec timestamp
...
output_directory = "results"  # Dossier où sauvegarder (créé automatiquement)
